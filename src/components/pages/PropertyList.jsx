      ...
      <div className="container-fluid  px-0 px-md-0">
        <div className="row mt-3 mb-0 g-3">
          <div className="col-12 col-lg-4 col-md-4 col-xl-4">
            <div className="card shadow rounded-4 border-0 text-start pt-5">
          ...
          <div className="col-sm-12 col-md-8 col-lg-8 col-xl-8">
            <div className="row">
              <div className="col-8">
                <select className="bg-white text-dark d-flex mb-3 p-2 pe-3 border mt-3 rounded-2 fw-bold">
            ...
            <div className="list card shadow rounded-4 border-0  text-start mb-3 ">
              <div className="">
                <div className="row align items-center">
                  ...
                  <div className="buylist col-6">
                    ...
                    <h5 className="name mt-1">
                      Luxury 4-bedroom in Lekki Phase 1
                    </h5>
            ...
            <div className="list card col shadow rounded-4 border-0 text-start mb-3">
              <div className="">
                <div className="row align items-center">
                  <div className="col-6">
                    <img
                      src="/images/Hotel-3.jpg"
                      className="img-fluid h-100  rounded position-absolute top-0 w-50 h-100"
                      alt="Property"
                    ></img>
                  </div>
                  <div className="buylist col-6">
                    ...
                    <h5 className="name mt-1">
                      Luxury 3-bedroom in Lekki Phase 1
                    </h5>
                    <p className="text-muted d-flex mb-2">
                      <svg
                        className="me-1 mt-1"
            ...
            <div className="list card col shadow rounded-4 border-0 text-start mb-3">
              <div className="">
                <div className="row align items-center">
                  ...
                  <div className="buylist col-6">
                    <span
                      className="badge position-absolute bg-white rounded-5 top-3 start-3 px-3 inset-s-0 "
                      style={{ color: "#2A478D" }}
                    >
                      LEASE
                    </span>
            ...
            <div className="list card col shadow rounded-4 border-0 text-start mb-3">
              <div className="">
                <div className="row align items-center">
                  ...
                  <div className="buylist col-6">
                    <span
                      className="badge position-absolute bg-white rounded-5 start-3 px-3 inset-s-0 top-3"
                      style={{ color: "#2A478D" }}
                    >
                      BUY
                    </span>
            ...
            <div className="list card col shadow rounded-4 border-0 text-start mb-3">
              <div className="">
                <div className="row align items-center">
                  ...
                  <div className="buylist col-6">
                    <span
                      className="badge position-absolute bg-white rounded-5 start-3 px-3 inset-s-0 top-2"
                      style={{ color: "#2A478D" }}
                    >
                        LEASE
                    </span>
                    <h5 className="name mt-1">
                      Luxury 5-bedroom in Lekki Phase 1
                    </h5>
                    <p className="text-muted d-flex mb-2">
                      <svg
                        className="me-1 mt-1"
