          ...
          <div className="col-sm-12 col-md-8 col-lg-8 col-xl-8">
            <div className="row mt-3">
              ...
              <div className="col-4 position-absolute end-0">
                <Link to="/rent" className="px-2 text-dark">
                  <svg
                    width="36"
                    height="36"
                    viewBox="0 0 36 36"
              ...
              <div className="">
                <div className="row align items-center">
                  ...
                  <div className="col-7">
                    ...
                    <Link to="/rent1" className="text-dark">
                      <button
            ...
            <div className="card col shadow rounded-4 border-0 text-start mb-3">
              <div className="">
                <div className="row align items-center">
                  ...
                  <div className="col-7">
                    <span
                      className="badge ms-2 btn position-absolute bg-white rounded-5 py-1  top-0 inset-s-0 mt-2 ms-0 px-3 "
                      style={{ color: "#2A478D" }}
                    >
                      RENT
                    </span>
