...
export default function FeaturesDetails() {
  ...
  return (
          ...
          <div className="container-fluid mt-4 ">
            <div className="row g-4 ms-4 me-4">
              <div className="col-lg-8 text-start">
                ...
                15 Admiralty Way {prop.location}
                </p>
                <h3
                ...
                <div className="row g-2 mb-4">
                  <div className="col-3">
                    <div className="bg-light rounded-3 p-3 text-start">
                      ...
                      <div className="fw-bold">{prop.bedroom}</div>
                ...
                <div className="border-bottom mb-3">
                  <Link to={`/property/${prop.slug}`}  className="text-dark">
              ...
              >
                Send Enquiry
                  ...
                  <button><a href={prop.whatsapp} className="btn btn-success w-100 text-decoration-none text-white bi bi-whatsapp">WhatsApp Agent
                    </a>
                  </button>
                </div>
              </div>
    ...
    <div><a href="https://wa.me/2348100854095">
        <span
