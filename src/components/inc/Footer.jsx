...
function Footer() {
  return (
    <>
      <div className="container-fluid bg-dark" style={{ paddingTop: "70px " }}>
        <div className="col-12 row flex-wrap flex-md-nowrap ms-0 me-5 pb-3">
          ...
          <div className="col-12 col-lg-3 col-xl-3 col-md-3 text-start">
            <p className=" text-white mb-3" style={{ fontFamily: "Georgia" }}>
              Quick Links
            </p>
          ...
          <div className="col-12 col-lg-3 col-xl-3 col-md-3 text-start">
            ...
            <p
              className="text-secondary mb-1 d-flex"
              style={{ fontSize: "16px" }}
            >
              <svg
                className="mt-1 me-1"
            ...
            <a
              href="mailto:ighoyotau@gmail.com"
